...
const requestArray = runupArray.filter((item) => item.type === 'request');
const approvedArray = runupArray.filter((item) => item.type === 'approved');
const rejectedArray = runupArray.filter((item) => item.type === 'rejected');

const RsRpmPage: React.FC = () => {
  ...
  return (
    <>
      <div className="wrapper">
        <Header title="Runup Pad Management" />
