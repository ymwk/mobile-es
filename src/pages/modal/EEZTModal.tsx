...
export const EEZTModal: React.FC<props> = (props) => {
    ...
    <Modal id={'modal'} isOpen={isOpen} onClose={onClose} header={<ModalHeader />}>
      <div className="modal-column">
        <div className="forms-column tobt-group">
          <h3 className="modal-title-sub">EEZT 설정</h3>
          ...
          <p className="msg c-err">EEZT설정 시 기준일시는 KST입니다.</p>
        </div>

        <div className="box-msg error">
          EEZT를 00:50로 수정하시겠습니까?
          <br />
          <em>잘못된 EEZT 입력 시 출발 순서가 변경 될 수 있습니다.</em>
        </div>
        <ModalAction>
